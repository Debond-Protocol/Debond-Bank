...
error Deadline(uint256 deadline, uint256 blockTimeStamp);
error PairNotAllowed();
error RateNotHighEnough(uint256 currentRate, uint256 minRate);
error INSUFFICIENT_AMOUNT(uint256 amount);
error INSUFFICIENT_LIQUIDITY(uint256 liquidity);
...
contract Bank is BankRouter, GovernanceOwnable {
   ...
   */
  function canPurchase(uint256 _classIdIn, uint256 _classIdOut) public view returns (bool) {
  ...
  function purchaseDBITBondsByStakingTokens(
    uint256 _purchaseClassId,
    uint256 _dbitClassId,
    ...
    uint256 _interestRate = interestRate(_purchaseClassId, _dbitClassId, _purchaseTokenAmount, PurchaseMethod.Staking);
  ...
  function purchaseDGOVBondsByStakingDBIT(
    uint256 _dbitClassId,
    uint256 _dgovClassId,
    uint256 _dbitTokenAmount,
    uint256 _minRate,
    uint256 _deadline,
    address _to
  ) external ensure(_deadline) {
    ...
    uint256 _interestRate = interestRate(_dbitClassId, _dgovClassId, _dbitTokenAmount, PurchaseMethod.Staking);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
  ...
  function purchaseDGOVBondsByStakingTokens(
    ...
    uint256 _interestRate = interestRate(_purchaseClassId, _dgovClassId, _purchaseTokenAmount, PurchaseMethod.Staking);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
   ...
   * @param _to address to interact with (transferring tokens from, ERC3475 tokens to)
   */
  function buyDBITBondsWithTokens(
    //else is not eth not dbit not dgov
    uint256 _purchaseClassId,
    uint256 _dbitClassId,
    uint256 _purchaseTokenAmount,
    uint256 _minRate,
    ...
    uint256 _interestRate = interestRate(_purchaseClassId, _dbitClassId, _purchaseTokenAmount, PurchaseMethod.Buying);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
  ...
  function buyDGOVBondsWithDBIT(
    ...
    uint256 _interestRate = interestRate(_dbitClassId, _dgovClassId, _dbitAmount, PurchaseMethod.Buying);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
  ...
  function buyDGOVBondsWithTokens(
    ...
    uint256 _interestRate = interestRate(_purchaseClassId, _dgovClassId, _purchaseTokenAmount, PurchaseMethod.Buying);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
    _addLiquidityDgovPair(_to, purchaseTokenAddress, _purchaseTokenAmount);
  ...
  function purchaseDBITBondsByStakingETH(
    ...
    uint256 purchaseTokenAmount = msg.value;
    uint256 _interestRate = interestRate(_wethClassId, _dbitClassId, purchaseTokenAmount, PurchaseMethod.Staking);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
  ...
  function purchaseDGOVBondsByStakingETH(
    ...
    uint256 purchaseTokenAmount = msg.value;
    uint256 _interestRate = interestRate(_wethClassId, _dgovClassId, purchaseTokenAmount, PurchaseMethod.Staking);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
   ...
   * @param _to address to interact with (transferring tokens from, ERC3475 tokens to)
   */
  function buyDBITBondsWithETH(
    //else is not eth not dbit
    uint256 _wethClassId,
    uint256 _dbitClassId,
    uint256 _minRate,
    uint256 _deadline,
    ...
    uint256 purchaseTokenAmount = msg.value;
    uint256 _interestRate = interestRate(_wethClassId, _dbitClassId, purchaseTokenAmount, PurchaseMethod.Buying);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
    IWETH(WETHAddress).deposit{ value: purchaseTokenAmount }();
  ...
  function buyDGOVBondsWithETH(
    ...
    uint256 purchaseTokenAmount = msg.value;
    uint256 _interestRate = interestRate(_wethClassId, _dgovClassId, purchaseTokenAmount, PurchaseMethod.Buying);
    if (_interestRate < _minRate) {
      revert RateNotHighEnough(_interestRate, _minRate);
    }
    IWETH(WETHAddress).deposit{ value: purchaseTokenAmount }();
  ...
  function interestRate(
    uint256 _purchaseTokenClassId,
    uint256 _debondTokenClassId,
    uint256 _purchaseTokenAmount,
    ...
    // buying Bonds
      ...
      uint256 debondTokenAmount = _convertToDbit(uint128(_purchaseTokenAmount), purchaseTokenAddress);
  ...
  function _issuingProcessStaking(
    ...
    uint256 _debondClassId,
    uint256 _rate,
    address _to
  ) private {
    uint256 amount = _convertToDbit(uint128(_purchaseTokenAmount), _purchaseTokenAddress);
